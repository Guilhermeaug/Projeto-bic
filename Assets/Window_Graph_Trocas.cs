...
public class Window_Graph_Trocas : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        int[] listaTrocas = info.getTrocas();
        valueList[0] = listaTrocas[0];
        valueList[1] = listaTrocas[1];
        valueList[2] = listaTrocas[2];
        valueList[3] = listaTrocas[3];
        valueList[4] = listaTrocas[4];
